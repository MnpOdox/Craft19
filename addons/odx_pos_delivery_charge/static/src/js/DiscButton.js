odoo.define('odx_pos_delivery_charge.DiscountButton', function (require) {
    'use strict';
    ...
    const PosFrDiscButton = DiscountButton => class extends DiscountButton {
        async onClick() {
            var self = this;
...
//            change the percentage to amount
            var discount = - pc
    ...
    Registries.Component.extend(DiscountButton, PosFrDiscButton);
